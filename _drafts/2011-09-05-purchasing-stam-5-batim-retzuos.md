---
layout: post
title: "Purchasing STAM: Part 5"
subtitle: Batim & Retzu’os
date: 2011-09-05
tags: [tefilin]
permalink: /purchasing-stam-5-batim-retzuos/
---
...
updated: 2020/01/13
category:  #tefilin
filename: /2011/09/purchasing-stam-part-5.html
-->
...
The [next]({% post_url 2011-10-03-purchasing-stam-6-sochrim %}) installment in this series will take a look at the middlemen who buy and sell STAM.

-= 8 =-
{: .sig}

[^fn2]: For an introduction to batim and retzu’os, see [STAM 101: Batim](/stam-101/#batim) and [STAM 101: Retzu’os](/STAM-101/#retzuos).

[^fn3]: The issue of uneven production quality is relevant even in factories with a hechsher. Although the hechsher sets the halachic standard, the certifying agency can not check out all the workers to make sure they always meet that standard.

[^fn4]: In recent history there have been numerous incidents where batim and retzu’os factories altered some aspect of their production – either innocently or maliciously – without the knowledge of the kashrus supervisors. These changes sometimes go undetected for months or years and often have a significant impact on the kashrus-level of the final products.

[^fn5]: Even in factories that produce “handmade” batim and retzu’os, the products are often only considered “handmade” according to minority halachic opinions.
