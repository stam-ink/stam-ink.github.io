---
layout: post
title: "Women Writing STAM: Index & Summary"
date: 2019-06-23
permalink: /soferet-index-summary/
---
...
updated: 2024/12/23
filename: /2019/06/soferet-index-summary.html
-->

<!-- כתיבת סת"ם על ידי נשים -->

{: .box}
“Women Writing STAM” is a short series of blog posts published over several months. Below are links to all of the posts in the series, along with an outline of the main points covered in each post. For more detailed information, click on the links to read the complete posts.
...
1. [Introduction]({% comment %}{% post_url 2019-03-06-soferet-1-intro %}{% endcomment %})
2. [Maseches Sofrim]({% comment %}{% post_url 2019-03-19-soferet-2-maseches-sofrim %}{% endcomment %})
3. [The Tur (& the Drisha)]({% comment %}{% post_url 2019-03-28-soferet-3-tur-drisha %}{% endcomment %})
4. [Megilas Ester]({% comment %}{% post_url 2019-05-06-soferet-4-megilas-ester %}{% endcomment %})
5. [Additional Sources]({% comment %}{% post_url 2019-06-05-soferet-addendum-additional-sources %}{% endcomment %})

### Summary
{: #summary}

***[Introduction]({% comment %}{% post_url 2019-03-06-soferet-1-intro %}{% endcomment %})***
...
***[Maseches Sofrim]({% comment %}{% post_url 2019-03-19-soferet-2-maseches-sofrim %}{% endcomment %})***
...
***[The Tur (& the Drisha)]({% comment %}{% post_url 2019-03-28-soferet-3-tur-drisha %}{% endcomment %})***
...
***[Megilas Ester]({% comment %}{% post_url 2019-05-06-soferet-4-megilas-ester %}{% endcomment %})***
...
***[Additional Sources]({% comment %}{% post_url 2019-06-05-soferet-addendum-additional-sources %}{% endcomment %})***
