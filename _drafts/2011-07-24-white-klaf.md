...
updated: 2020/03/02
filename: /2011/07/white-klaf.html
-->

People looking to buy a megila or Sefer Torah often ask for “white klaf”.[^fn1] It may seem like a simple enough request, but it actually introduces many complications, and even when it’s possible, it can often result in an inferior end-product.

![klaf samples]({{ site.baseurl }}/{>>URL<<} "klaf samples."){: .full}
...
![Mezuza klaf]({{ site.baseurl }}/{>>URL<<} "Mezuza klaf (click to open image in a new window)"){: .third-r}
...
[^fn3]: Some of the characteristics of “the best klaf” are objective – soft klaf is objectively better than hard klaf. Some characteristics are subjective – some Sofrim prefer smooth klaf and some prefer a more velvety finish.
