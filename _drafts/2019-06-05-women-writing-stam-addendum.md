...
Below are the complete quotations from all of the poskim that were mentioned (but not quoted directly) in [part two]({% comment %}{% post_url 2019-03-19-soferet-2-maseches-sofrim %}{% endcomment %}) of the series.[^fn1]
...
[^fn1]: Missing from this list is the Rambam, who was quoted in full in the [earlier post]({% comment %}{% post_url 2019-03-19-soferet-2-maseches-sofrim#rambam %}{% endcomment %}).
