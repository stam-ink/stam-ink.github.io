...
**update**{: .ultra}: The best kind of klaf is *shlil*, which is made from the skin of a cow fetus. From a technical perspective, shlil is generally softer and denser than klaf made from the skin of a more mature animal. This results in a surface that is easier to write on and more forgiving of erasures – resulting in a superior final product. Shlil also has other hidurim that are kabalistic in nature. 

Due to the rising cost of shlil, some klaf-makers have begun offering klaf made from calfskin at a slight discount. This klaf, called *egel*, is still considered mehudar. A buyer who only wants STAM written on shlil would need to specify that preference in advance when ordering the STAM item.

-= 8 =-
{: .sig}

[^fn1]: For a brief introduction to klaf, see [STAM 101: Klaf](/stam-101/#klaf). For information on what to look for (and what to avoid) when choosing a klaf factory see [Purchasing STAM Part 4]({% post_url 2011-07-17-purchasing-stam-4-klaf %}). To learn why not to judge klaf based solely on color, see [White Klaf]({% post_url 2011-07-24-white-klaf %}) and [More About White Klaf]({% post_url 2017-07-04-more-about-white-klaf %}).

[^fn2]: Which side of the split hide is klaf and which side is duchsustus is actually the subject of a disagreement among the Rishonim, but the majority opinion – and the consensus among the Achronim – is that the klaf is the upper layer.

[^fn3]: If the Jew was standing at a distance when he told the non-Jew to do the work lishma, or if the Jew was right next to him but didn’t explicitly tell him to do the work lishma *at the very moment he puts the skins into tanning solution*, the klaf is invalid. All of this follows the opinion of the Rosh. According to the opinion of the Rambam, the work *must* be done by a Jew.
