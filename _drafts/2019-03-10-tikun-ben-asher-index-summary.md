---
layout: post
title: "Tikun Ben Asher: Index & Summary"
date: 2019-03-10
permalink: /keter-index-summary/
---
...
updated: 2024/12/23
filename: /2019/03/tikun-ben-asher-index-summary.html
-->

{: .box}
The “Tikun Ben Asher” series of blog posts was published intermittently over many months. Below are links to all of the posts in the series, along with an outline of the key points covered in each post. For more information, click on the links to read the complete posts.

![Divrei Hayamim]({{ site.baseurl }}/{>>URL<<} "Divrei Hayamim II 35-36"){: .half-r}
...
- Minor differences in the text – mostly in layout (parsha type & placement) and spelling (maleh / chaser) – propagated over time.
...
- Most Ashkenazim follow the Keses Hasofer, although some Ashkenazi poskim advocate following the Tikun Ben Asher.
- Yemenites follow the Tikun Ben Asher.
- Most Sefardim follow the Keses Hasofer for parshi’os, but the Tikun Ben Asher for spelling.
