---
layout: post
title: "Purchasing STAM: Part 6"
subtitle: "Sochrim: Retailers, Dealers & Other Middlemen"
date: 2011-10-03
permalink: /purchasing-stam-6-sochrim/
---
...
updated: 2021/04/20
filename: /2011/10/purchasing-stam-part-6.html
-->

## *Sochrim*: Retailers, Dealers & Other Middlemen
...
[The]({% comment %}{% post_url 2011-06-19-purchasing-stam-2-sofer %}{% endcomment %}) [last]({% comment %}{% post_url 2011-07-04-purchasing-stam-3-proofreading-psak %}{% endcomment %}) [few]({% comment %}{% post_url 2011-07-17-purchasing-stam-4-klaf %}{% endcomment %}) [posts]({% comment %}{% post_url 2011-09-05-purchasing-stam-5-batim-retzuos %}{% endcomment %}) in this series discussed the creation of STAM – the people who manufacture the various parts and the methods and materials they use. This post will address the buying and selling of STAM and the merchants who are often the only public face of the STAM industry.

![STAM in the shuk.]({>>URL<<} "STAM in the shuk (image for illustration purposes only)."){: .full}
...
![Retail STAM.]({>>URL<<} "Retail STAM (image for illustration purposes only)."){: .third-r}

Even when dealing with a retailer who is an expert in the laws of STAM, there is another potential pitfall; as noted in [the first post]({% comment %}{% post_url 2011-06-03-purchasing-stam-part-1 %}{% endcomment %}) in this series, the competition in the STAM market is strong. A retailer who is an expert in STAM still has to compete with the Judaica gallery down the block which is selling pasul mezuzos as *kosher* and bidi’eved mezuzos as *mehudar*. Even if the retailer is an honest person who would never knowingly sell something pasul, he may use phrases like *basic kosher* when labeling STAM that is only kosher bidi’eved, and he might say that *the writing is mehudar* when describing a handwriting sample that is aesthetically beautiful but may have minor halachic deficiencies.
...
This post made several references to the halachic quality of STAM: bidi’eved, lechatchila, and mehudar. The [next post]({% comment %}{% post_url 2011-12-17-purchasing-stam-7-bidieved-lechatchila-mehudar %}{% endcomment %}) in this series will define the different levels as they relate to STAM.
