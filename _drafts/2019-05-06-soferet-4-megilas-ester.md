---
layout: post
title: "Women Writing STAM: Part 4"
subtitle: Megilas Ester
date: 2019-05-06
tags: [megila]
permalink: /soferet-4-megilas-ester/
---
...
updated: 2021/04/20
category:  #megila
filename: /2019/05/soferet-4-megilas-ester.html
-->
...
![Ester wrote]({{ site.baseurl }}/{>>URL<<} "Ester wrote with full authority to uphold this second letter of Purim."){: .full}

[The]({% post_url 2019-03-06-soferet-1-intro %}) [previous]({% post_url 2019-03-19-soferet-2-maseches-sofrim %}) [posts]({% post_url 2019-03-28-soferet-3-tur-drisha %}) in this series addressed the halachic issues regarding women writing Sifrei Torah, tefilin, and mezuzos. This post will focus on a related topic – women writing megilas Ester.[^fn1]
...
- Kisvei kodesh (scrolls containing individual books of Tanach, or any collection of books of Tanach other than Sifrei Torah).[^fn2]

As a general rule, the halachos of writing Sifrei Torah are more stringent than those of kisvei kodesh. One of the differences between Sifrei Torah and kisvei kodesh relates to the concept of *lishma*.[^fn3] The materials used to make Sifrei Torah (and tefilin & mezuzos) must be prepared lishma. For example, when manufacturing klaf for a Sefer Torah, the skins must be processed for the express purpose of writing a Sefer Torah. In contrast, parchment used to write kisvei kodesh does *not* need to be made lishma. Even if the hides were originally processed to be made into shoes or a handbag or a couch – if you turn them into parchment, you can write kisvei kodesh on them.
...
We have [already established]({% post_url 2019-03-28-soferet-3-tur-drisha %}#conclusion) that a woman cannot write a Sefer Torah, but technically a woman *is* allowed to write kisvei kodesh. Because of megilas Ester’s “dual identity”, arguments could be made both for and against women writing megilas Ester.
...
The Shulchan Aruch, in discussing the halachic requirements of megilas Ester,[^fn4] mentions both the opinions of Rabeinu Tam and the Magid Mishna:
...
In terms of practical application, the halacha is not so clear-cut: Even though the majority of Achronim hold that women can write a megila, within that position there are a number of prominent poskim who say that *in practice* you should **not** read from such a megila.[^fn5] One contemporary posek who reaches this conclusion is Rav Ovadia Yosef,[^fn6] who adds that in a bidi’eved situation – where you don’t have access to another megila – you can fulfill your obligation by reading from a megila written by a woman.

-= 8 =-
{: .sig}

[^fn5]: The halachos of women *reading* megilas Ester are outside the purview of this blog.

[^fn6]: See [STAM 101: Kisvei Kodesh](/stam-101/#kisvei-kodesh) for more details.

[^fn2]: Certain tasks must be done with specified intent. See [STAM 101: Lishma](/stam-101/#lishma) for more details.

[^fn4]: Orach Chaim 691:1.

[^fn3]: At least not lechatchila.

[^fn1]: Yabi’ah Omer: Orach Chaim 55.
