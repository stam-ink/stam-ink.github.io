---
layout: post
title: "Women Writing STAM: Part 3"
subtitle: The Tur and the Drisha
date: 2019-03-28
permalink: /soferet-3-tur-drisha/
---
...
updated: 2020/08/02
filename: /2019/03/soferet-3-tur-and-drisha.html
-->
...
The [previous post]({% comment %}{% post_url 2019-03-19-soferet-2-maseches-sofrim %}{% endcomment %}) in this series cited a long list of Rishonim and Achronim who say that women may not write Sifrei Torah, tefilin, or mezuzos. There is one major code of Jewish law which was not mentioned, and that is the Tur.[^fn1] The Tur discusses our topic in two different places: Once in Orach Chaim and again in Yoreh De’ah.
...
{: .callout #note}
**NOTE:**{: .ultra} Here, the Tur is paraphrasing the statement of [Rav Nachman]({% comment %}{% post_url 2019-03-06-soferet-1-introduction#rav-nachman %}{% endcomment %}). This halacha does not reference the beraisa of Rav Hamnuna at all.
...
There is one final issue that still needs to be addressed: Until now the discussion has been limited to Sifrei Torah, tefilin, and mezuzos. There is another sacred item commonly written by sofrim, and that is megilas Ester – which will be the topic of the [next post]({% comment %}{% post_url 2019-05-06-soferet-4-megilas-ester %}{% endcomment %}).

-= 8 =-
{: .sig}

[^fn3]: The Tur was written by Rabeinu Ya’akov Ben Asher – the son of the Rosh, among the last of the Rishonim, and one of the early codifiers of halacha.

[^fn1]: It would be unusual in the modern era for a Sefer Torah to be used for private study, but this was not always the case: Until the Gutenberg revolution, the only way to study any text was to write it out by hand.

[^fn2]: Rif: Halachos Ketanos, Hilchos Tefilin 7a. <br />
