...
filename: /2011/08/old-sifrei-torah.html
-->

![Iraqi Torah]({{ site.baseurl }}/{>>URL<<} "100-year-old Torah."){: .full}
...
{: .callout #note}
**NOTE:**{: .ultra} In most situations, *fit for use* means *kosher* [*bidi’eved*]({% post_url 2011-12-17-purchasing-stam-7-bidieved-lechatchila-mehudar %}#bidieved). To bring a 50- or 100-year-old Sefer Torah to a state where it could be called *kosher [lechatchila]({% post_url 2011-12-17-purchasing-stam-7-bidieved-lechatchila-mehudar %}#lechatchila)*, the amount of work required can end up costing as much as *(or even more than) *the initial purchase price.
